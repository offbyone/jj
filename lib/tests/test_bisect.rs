...
fn test_bisection<'a>(
    ...
    results: impl IntoIterator<Item = (&'a CommitId, TestResult)>,
) -> BisectionResult {
...
fn test_bisect_linear() {
    ...
    let expected_tests = [
        (commit3.id(), TestResult::Bad),
        (commit1.id(), TestResult::Bad),
        (root_commit.id(), TestResult::Bad),
    ];
    ...
    let expected_tests = [
        (commit3.id(), TestResult::Bad),
        (commit1.id(), TestResult::Bad),
        (root_commit.id(), TestResult::Good),
    ];
    let result = test_bisection(tx.repo(), &input_range, expected_tests);
    ...
    let expected_tests = [
        (commit3.id(), TestResult::Bad),
        (commit1.id(), TestResult::Good),
        (commit2.id(), TestResult::Good),
    ];
    let result = test_bisection(tx.repo(), &input_range, expected_tests);
    ...
    let expected_tests = [
        (commit3.id(), TestResult::Good),
        (commit5.id(), TestResult::Bad),
        (commit4.id(), TestResult::Good),
    ];
    let result = test_bisection(tx.repo(), &input_range, expected_tests);
    ...
    let expected_tests = [
        (commit3.id(), TestResult::Good),
        (commit5.id(), TestResult::Good),
        (commit6.id(), TestResult::Good),
    ];
    let result = test_bisection(tx.repo(), &input_range, expected_tests);
    ...
    let expected_tests = [
        (commit3.id(), TestResult::Skip),
        (commit2.id(), TestResult::Bad),
        (root_commit.id(), TestResult::Good),
        (commit1.id(), TestResult::Good),
    ];
    let result = test_bisection(tx.repo(), &input_range, expected_tests);
    ...
    let expected_tests = [
        (commit3.id(), TestResult::Skip),
        (commit2.id(), TestResult::Skip),
        (commit4.id(), TestResult::Skip),
        (commit1.id(), TestResult::Skip),
        (commit5.id(), TestResult::Skip),
        (root_commit.id(), TestResult::Skip),
        (commit6.id(), TestResult::Good),
    ];
    let result = test_bisection(tx.repo(), &input_range, expected_tests);
    assert_eq!(result, BisectionResult::Found(vec![commit7.clone()]));
